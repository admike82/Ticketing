 ...
 */
final class Version20230915171132 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ticket (id INT NOT NULL, status_id INT NOT NULL, level_id INT NOT NULL, user_account_id INT DEFAULT NULL, author VARCHAR(255) NOT NULL, content TEXT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, api_id VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
